 ...
 * mechanism behind `CST-<n>` customer display ids, copied unchanged from
 * shipping-service's `store-sequence.util.ts` (itself copied from
 * order-service's `RMA-<n>` precedent).
 *
